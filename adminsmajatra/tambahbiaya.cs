...
{
    public partial class tambahbiaya : Form
    {
        ...
        private void tambahbiaya_Load(object sender, EventArgs e)
        {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("\t\t\t SURAT PEMBERITAHUAN TAGIHAN SMA MA'ARIF NU JATINEGARA \n\n\n", font, Brushes.Black, 25, 10);
            ...
            e.Graphics.DrawString("Tanggal Penambahan\t: " + textBox17.Text + "\n\n", font, Brushes.Black, 20, 310);

            e.Graphics.DrawString("   Demikian surat ini kami sampaikan harap melakukan pembayaran \n\n\n", font, Brushes.Black, 21, 340);
            e.Graphics.DrawString("sebelum tanggal  \n\n\n", font, Brushes.Black, 20, 360);
            e.Graphics.DrawString("    Kepala TATA USAHA                                                                     Kepala SMA MA'ARIF NU JATINEGARA \n\n\n", font, Brushes.Black, 20, 400);
